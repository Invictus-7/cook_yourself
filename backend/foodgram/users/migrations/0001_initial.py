# Generated by Django 2.2.16 on 2022-09-14 12:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='follow',
            constraint=models.CheckConstraint(check=models.Q(_negated=True, user=django.db.models.expressions.F('author')), name='follow_prevent_self_follow'),
        ),
        migrations.AddConstraint(
            model_name='user',
